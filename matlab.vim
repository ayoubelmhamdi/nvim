...
syn region matlabFunction	matchgroup=matlabFunction start="^\s*\h\w*\s*(" end=")"	contains=matlabVar,matlabStringArray,matlabString,matlabNumber,matlabFloat
...
syn match matlabVar	         display contained    "\<[a-zA-Z0-9]\+\>"
" Standard numbers
...
syn keyword matlabFunction		error eval function endfunction input printf fprintf sprintf
