...
" copy this next line at top init.vim or fisrt source:
" this line start listing to all maping of leader key
" let g:which_key_map =  {}
" than start maping in all init vim and sources
" than add this line at bottom if init.vim or botom last source
" call which_key#register('<Space>', "g:which_key_map")
" betwin thos tow lines you cant rename or hide 
" any leader key from which_key list

" idont know why i'am used know
let @s = 'veS"'
" Hide status line
...
let g:which_key_map['a'] = 'codeaction selected'
let g:which_key_map['f'] = 'format selected'
let g:which_key_map['w'] = 'source vim'
let g:which_key_map['g'] = 'splite paragraph'
let g:which_key_map['ac'] = 'codeaction'
let g:which_key_map['tc'] = 'colorizer'
let g:which_key_map['gc'] = 'i dont know'
let g:which_key_map['vp'] = 'vim plugin'
let g:which_key_map['vi'] = 'vim init'
let g:which_key_map[ 'v'] = 'vim set-setting'
let g:which_key_map[ 'n'] = 'new tab'
...
let g:which_key_map.qf = 'which_key_ignore'
...
" 
" let g:which_key_map[',s'] = [ ':setlocal spell!<CR>'                                    , ' spell' ]
let g:which_key_map['/'] = [ ':Commentary!'                                    , 'Commentary' ]
let g:which_key_map['e'] = [ ':CocCommand explorer --toggle --sources=file+'   , 'explorer' ]
let g:which_key_map['r'] = [ '<C-W>v'                                          , 'ᐅ']
let g:which_key_map['b'] = [ '<C-W>s'                                          , 'ᐁ']
