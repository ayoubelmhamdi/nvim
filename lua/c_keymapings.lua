...
nnoremap ,cl :r!cat-loop last<cr>
nnoremap ,cn :r!cat-loop next<cr>
nnoremap ,cp :r!cat-loop prev<cr>
nnoremap ,ct :r!cat-loop last 1<cr>
"
nnoremap ,or :OverseerRun<cr>
nnoremap ,ol :OverseerLoadBundle<cr>
nnoremap ,ot :OverseerTaskAction<cr>
nnoremap ,oq :OverseerQuickAction<cr>
nnoremap ,ov :OverseerQuickAction open vsplit<cr>
